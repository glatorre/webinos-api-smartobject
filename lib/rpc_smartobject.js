...
(function () {
    ...
    var SmartObjectModule = function (rpcHandler, params) {
        ...
        this.base({api:'http://webinos.org/api/smartobject.fornoamicroonde'
            , displayName:'Smart Object API'
        ...
        this.init = function(register, unregister) {
            ...
            for(var i in objects){
                ...
                var service = new sslib.SmartObjectService(rpcHandler, objects[i]);
                register(service);
